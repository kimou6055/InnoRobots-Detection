...
# keep looping
while True:
    # grab the current img_top_down
    img_top_down = vs.read()

    # handle the img_top_down from VideoCapture or VideoStream
    img_top_down = img_top_down[1] if args.get("video", False) else img_top_down

    # if we are viewing a video and we did not grab a img_top_down,
    # then we have reached the end of the video
    if img_top_down is None:
        break
    ...
    # show the img_top_down to our screen
    cv2.imshow("img_top_down", img_top_down)
